<template>
  <div>
    <div class="q-mx-md" style="margin-top: 20px" dense>
      ...
      <div class="text-h6 q-pb-xs" v-if="paciente" dense>
        {{ paciente.nombre }}
      </div>
    ...
    <div class="q-pa-md" style="max-width: 450px">
      <q-list>
        ...
        >
          <Convertidor class="q-pb-md" ref="convert" />
        </q-expansion-item>
        <q-expansion-item
          icon="book"
          expand-separator
        ...
        >
          ...
          <q-card-section v-html="paciente.antecedentes" v-if="paciente">
          </q-card-section>
          <!-- </q-card> -->
        </q-expansion-item>
        ...
        >
          <!-- <q-card class="bg-grey-3"> -->
          <q-card-section
            v-html="paciente.medicamentosPermanentes"
            v-if="paciente"
          >
          </q-card-section>
          <!-- </q-card> -->
        ...
        >
          ...
          <q-card-section v-html="consulta.receta" v-if="consulta" dense>
          </q-card-section>
        </q-expansion-item>
